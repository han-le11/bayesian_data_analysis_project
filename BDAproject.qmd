...
There are 900 observations in the dataset. Each row contains information about a house. In the original dataset, there are 10 variables. However, for the analysis, we add a variable called $Age = 2023 - ProductionYear$ to compute the age of the house using the year it was produced. 
...
The structure of our analysis with the non-linear model is similar to that of the linear model. We first fit the model, then report convergence diagnostics
